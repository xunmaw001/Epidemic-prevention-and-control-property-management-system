          ...
          <el-form-item class="input" v-if="ruleForm.biaoti" label="标题" prop="biaoti">
              <el-input v-model="ruleForm.biaoti" 
                placeholder="标题" readonly></el-input>
                                                                  ...
                                                                  <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="发表日期" prop="fabiaoriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.fabiaoriqi" 
                type="date"
                placeholder="发表日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fabiaoriqi" label="发表日期" prop="fabiaoriqi">
              <el-input v-model="ruleForm.fabiaoriqi" 
                placeholder="发表日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
                                      <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="发表内容" prop="fabiaoneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="发表内容"
                  v-model="ruleForm.fabiaoneirong">
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.fabiaoneirong" label="发表内容" prop="fabiaoneirong">
                    <span>{{ruleForm.fabiaoneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='fabiaoneirong'){
            this.ruleForm.fabiaoneirong = obj[o];
            continue;
          }
                    if(o=='fabiaoriqi'){
            this.ruleForm.fabiaoriqi = obj[o];
            continue;
          }
                  }
                                                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `gonggaohuifu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.gonggaohuifuCrossAddOrUpdateFlag = false;
                  this.parent.search();
