      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="单元号" prop="danyuanhao">
          <el-input v-model="ruleForm.danyuanhao" 
              placeholder="单元号" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.danyuanhao" label="单元号" prop="danyuanhao">
              <el-input v-model="ruleForm.danyuanhao" 
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fanghao" label="房号" prop="fanghao">
              <el-input v-model="ruleForm.fanghao" 
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shenfenzheng" label="身份证" prop="shenfenzheng">
              <el-input v-model="ruleForm.shenfenzheng" 
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shouji" label="手机" prop="shouji">
              <el-input v-model="ruleForm.shouji" 
