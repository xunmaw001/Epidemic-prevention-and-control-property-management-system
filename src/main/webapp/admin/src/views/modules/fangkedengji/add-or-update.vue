  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fangkexingming" label="访客姓名" prop="fangkexingming">
              <el-input v-model="ruleForm.fangkexingming" 
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhiye" label="职业" prop="zhiye">
              <el-input v-model="ruleForm.zhiye" 
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhuzhi" label="住址" prop="zhuzhi">
              <el-input v-model="ruleForm.zhuzhi" 
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.wendu" label="温度" prop="wendu">
              <el-input v-model="ruleForm.wendu" 
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `fangkedengji/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.fangkedengjiCrossAddOrUpdateFlag = false;
                  this.parent.search();
