<template>
  <div class="main-content">
        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column label="索引" v-if="contents.tableIndex" type="index" width="50" />
                ...
                <el-button v-if="isAuth('gonggaoxinxi','查看') && contents.tableBtnIcon == 0" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">{{ contents.tableBtnFont == 1?'详情':'' }}</el-button>
                                                                <el-button v-if="isAuth('gonggaoxinxi','发布') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="gonggaohuifuCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'发布':'' }}</el-button>
                <el-button v-if="isAuth('gonggaoxinxi','发布') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="gonggaohuifuCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'发布':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('gonggaoxinxi','发布') && contents.tableBtnIcon == 0" type="success" size="mini" @click="gonggaohuifuCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'发布':'' }}</el-button>
    ...
    <add-or-update v-if="addOrUpdateFlag" :parent="this" ref="addOrUpdate"></add-or-update>
            ...
            <gonggaohuifu-cross-add-or-update v-if="gonggaohuifuCrossAddOrUpdateFlag" :parent="this" ref="gonggaohuifuCrossaddOrUpdate"></gonggaohuifu-cross-add-or-update>
...
import gonggaohuifuCrossAddOrUpdate from "../gonggaohuifu/add-or-update";
export default {
  data() {
    return {
                                                                              searchForm: {
      ...
      addOrUpdateFlag:false,
                  gonggaohuifuCrossAddOrUpdateFlag: false,
  ...
  methods: {
    ...
    contentPageStyleChange(){
      ...
      this.contents.pageEachNum = 10
            ...
            gonggaohuifuCrossAddOrUpdateHandler(row,type){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.gonggaohuifuCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj',row);
      this.$storage.set('crossTable','gonggaoxinxi');
      this.$nextTick(() => {
        this.$refs.gonggaohuifuCrossaddOrUpdate.init(row.id,type);
      });
    },
                    init () {
                                                                                                            },
