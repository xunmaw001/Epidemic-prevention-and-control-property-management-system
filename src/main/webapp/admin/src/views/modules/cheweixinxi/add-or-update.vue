      ...
      <el-row>
          ...
          <el-form-item class="input" v-if="ruleForm.mingcheng" label="名称" prop="mingcheng">
              <el-input v-model="ruleForm.mingcheng" 
                placeholder="名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="原车位号" prop="yuancheweihao">
          <el-input v-model="ruleForm.yuancheweihao" 
              placeholder="原车位号" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.yuancheweihao" label="原车位号" prop="yuancheweihao">
              <el-input v-model="ruleForm.yuancheweihao" 
                placeholder="原车位号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="车牌" prop="chepai">
          <el-input v-model="ruleForm.chepai" 
              placeholder="车牌" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chepai" label="车牌" prop="chepai">
              <el-input v-model="ruleForm.chepai" 
          ...
          <el-form-item class="input" v-if="ruleForm.xingming" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="换车位号" prop="huancheweihao">
          <el-input v-model="ruleForm.huancheweihao" 
              placeholder="换车位号" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.huancheweihao" label="换车位号" prop="huancheweihao">
              <el-input v-model="ruleForm.huancheweihao" 
                placeholder="换车位号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='yuancheweihao'){
            this.ruleForm.yuancheweihao = obj[o];
            continue;
          }
                    if(o=='chepai'){
            ...
            continue;
                    ...
                    if(o=='huancheweihao'){
            this.ruleForm.huancheweihao = obj[o];
            continue;
          }
                    if(o=='sfsh'){
