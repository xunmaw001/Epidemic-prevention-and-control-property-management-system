        ...
        <div v-else>
          <el-form-item v-if="ruleForm.jiancebaogao" label="检测报告" prop="jiancebaogao">
            <el-button type="text" size="small" @click="download(ruleForm.jiancebaogao)">下载</el-button>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="检测温度" prop="jiancewendu">
          <el-input v-model="ruleForm.jiancewendu" 
              placeholder="检测温度" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jiancewendu" label="检测温度" prop="jiancewendu">
              <el-input v-model="ruleForm.jiancewendu" 
                placeholder="检测温度" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.xingming" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                                    ...
                                                    <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="检测情况" prop="jianceqingkuang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="检测情况"
                  v-model="ruleForm.jianceqingkuang">
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jianceqingkuang" label="检测情况" prop="jianceqingkuang">
                    <span>{{ruleForm.jianceqingkuang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='jianceqingkuang'){
            this.ruleForm.jianceqingkuang = obj[o];
            continue;
          }
                    if(o=='jiancebaogao'){
            ...
            continue;
                    ...
                    if(o=='jiancewendu'){
            this.ruleForm.jiancewendu = obj[o];
            continue;
          }
                    if(o=='yonghuming'){
