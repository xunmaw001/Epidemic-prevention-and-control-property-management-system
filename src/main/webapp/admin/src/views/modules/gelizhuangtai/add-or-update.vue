  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" v-if="ruleForm.mingcheng" label="名称" prop="mingcheng">
              <el-input v-model="ruleForm.mingcheng" 
                placeholder="名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="隔离房号" prop="gelifanghao">
          <el-input v-model="ruleForm.gelifanghao" 
              placeholder="隔离房号" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.gelifanghao" label="隔离房号" prop="gelifanghao">
              <el-input v-model="ruleForm.gelifanghao" 
                placeholder="隔离房号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="隔离时间" prop="gelishijian">
          <el-input v-model="ruleForm.gelishijian" 
              placeholder="隔离时间" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.gelishijian" label="隔离时间" prop="gelishijian">
              <el-input v-model="ruleForm.gelishijian" 
                placeholder="隔离时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="隔离状态" prop="gelizhuangtai">
          <el-select v-model="ruleForm.gelizhuangtai" placeholder="请选择隔离状态">
            <el-option
                v-for="(item,index) in gelizhuangtaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.gelizhuangtai" label="隔离状态" prop="gelizhuangtai">
              <el-input v-model="ruleForm.gelizhuangtai" 
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='gelifanghao'){
            this.ruleForm.gelifanghao = obj[o];
            continue;
          }
                    if(o=='gelishijian'){
            ...
            continue;
                    ...
                    if(o=='gelizhuangtai'){
            this.ruleForm.gelizhuangtai = obj[o];
            continue;
          }
                    if(o=='kaishiriqi'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                ...
                                                                                                this.gelizhuangtaiOptions = "未隔离,隔离中,隔离完".split(',')
                                              },
                                                // 多级联动参数
                                                              info(id) {
      this.$http({
        url: `gelizhuangtai/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `gelizhuangtai/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.gelizhuangtaiCrossAddOrUpdateFlag = false;
                  this.parent.search();
