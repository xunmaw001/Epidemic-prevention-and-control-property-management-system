  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 215, 0, 0.02);borderRadius:20px">
        <h1 class="h1" style="color:rgba(255, 69, 0, 1);fontSize:30px;">疫情防控物业管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="用户名" class="input" v-if="tableName=='yezhu'">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='yezhu'">
			...
			<el-form-item label="单元号" class="input" v-if="tableName=='yezhu'">
			  <el-input v-model="ruleForm.danyuanhao" autocomplete="off" placeholder="单元号" type="text" />
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.fanghao" class="input" type="text" placeholder="房号">
			   </div>
			 </div> -->
			<el-form-item label="房号" class="input" v-if="tableName=='yezhu'">
