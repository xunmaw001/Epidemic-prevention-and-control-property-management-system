<template>
  <div>
    ...
    >  
     <el-row>
                              <el-col :span="12">
        <el-form-item  v-if="flag=='yezhu'"  label="用户名" prop="yonghuming">
          <el-input v-model="ruleForm.yonghuming" 
              placeholder="用户名" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item  v-if="flag=='yezhu'"  label="密码" prop="mima">
          <el-input v-model="ruleForm.mima" 
              placeholder="密码" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item  v-if="flag=='yezhu'"  label="姓名" prop="xingming">
        ...
        <el-form-item v-if="flag=='yezhu'" label="头像" prop="touxiang">
          ...
          ></file-upload>
                        ...
                        <el-col :span="12">
        <el-form-item  v-if="flag=='yezhu'"  label="单元号" prop="danyuanhao">
          <el-input v-model="ruleForm.danyuanhao" 
              placeholder="单元号" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item  v-if="flag=='yezhu'"  label="房号" prop="fanghao">
